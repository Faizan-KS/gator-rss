...
func main() {
	...
	cmds.register("allfeeds", handlerGetAllFeeds)
	cmds.register("follow", middlewareLoggedIn(handlerFollow))
	cmds.register("following", middlewareLoggedIn(handlerFollowing))
	cmds.register("unfollow", middlewareLoggedIn(handlerDeleteFeedByURL))
	cmds.register("myfeedposts", middlewareLoggedIn(handlerGetPostsForUser))
